...
#define AVS_PROC_ALIGN		4	// ����ͼ��Ķ���λ��Ҫ��
...
typedef struct _AVS_RADAR_PREINFO_ {
	int							radar_point_num;	// �����ȥ��ͬʱ�̵��״���Ϣ
	AVS_RADAR_POINT_PRE_INFO	*radar_cal_info;	// ȷ��ʱ�̵��״���Ϣ��0���������Ϣ
}AVS_RADAR_PREINFO;

typedef struct _AVS_RADAR_FILTER_ {
	int							radar_info_cache_num;
	AVS_RADAR_PREINFO			radar_pre_info[AVS_MAX_RADAR_CACHE];	// ���״���ϢԤ�����õ�����ѵ����Ҫ����Ϣ
